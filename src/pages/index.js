  ...
  return (
    <>
      ...
      <div className="bg-[#6b7c66] h-[360px] md:h-[470px] lg:h-[580px] pl-[8%] md:pl-[10%] lg:pl-[14%] pr-[2%] pt-[12%] sm:pt-[10%] md:pt-[12%] lg:pt-[8%]">
        ...
        {/* <div className="text-[#cac9c9] mt-8 font-['Inter'] text-2xl"> */}
          ...
          {buttons.map((el, idx) => {
            return (
              <button 
                key={idx}
                id={el.id}
                // className="text-[#cac9c9] bg-[#6b7c66] w-10 h-10 ml-[1%] border-[1.5px]  border-solid border-[#cac9c9] rounded-full"  
